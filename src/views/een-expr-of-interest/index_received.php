...
$this->params['breadcrumbs'][] = $this->title . ' ' . \lispa\amos\een\AmosEen::t('amoseen', 'received');
   ...
   echo \lispa\amos\core\views\AmosGridView::widget([
        ...
        //'filterModel' => $model,
            'columns' => [
                ...
                [
                    'label' => \lispa\amos\een\AmosEen::t('amoseen', '#eoi_sended_by'),
                ...
                [
                    ...
                    'buttons' => [
                        ...
                        'transfer' => function ($url, $model) {
                            if($model->status != \lispa\amos\een\models\EenExprOfInterest::EEN_EXPR_WORKFLOW_STATUS_CLOSED && !empty($model->een_staff_id)) {
                                return Html::a(\lispa\amos\core\icons\AmosIcons::show('refresh'), 'javascript:void(0)',
                                    [
                                        'model' => $model,
...
\yii\bootstrap\Modal::begin([
    'id' => 'modal_transfer',
    'header' => '<h2>'.\lispa\amos\een\AmosEen::t('amoseen','#transfer_expr_of_interest').'</h2>',
    'size' => \yii\bootstrap\Modal::SIZE_LARGE,
//    'toggleButton' => ['label' => \lispa\amos\core\icons\AmosIcons::show('time'), 'class' => 'btn btn-tool-secondary'],
]);
?>
